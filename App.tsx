    ...
    <div className="min-h-screen bg-gray-50 pb-24 relative">
      ...
      <header className="bg-white px-6 pt-12 pb-2 rounded-b-3xl shadow-sm border-b border-teal-50 sticky top-0 z-10">
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-teal-600 font-medium">{ageDisplay} old • {profile.gender}</p>
          </div>
          <button 
                 ...
                 {aiAnalysis ? (
                   <div className="relative z-10">
                     ...
                     <div className="mt-4 pt-4 border-t border-white/20 flex justify-between items-center">
                        <span className="text-xs opacity-70">Generated by Gemini AI</span>
                        <button 
                   ...
                   <div className="text-center py-4 relative z-10">
                     <p className="mb-4 text-indigo-100 text-sm">Get a personalized analysis of {profile.name}'s growth trend compared to standard curves.</p>
                     <Button 
                       onClick={handleGetInsight} 
                     ...
                     >
                       {records.length === 0 ? "Add Data First" : "Analyze Growth"}
                     </Button>
                   </div>
                 )}
              </div>
      ...
      <div className="fixed bottom-6 right-6 z-20">
        <button
          ...
          aria-label={activeTab === 'growth' ? "Add growth record" : "Add vaccine record"}
        >
